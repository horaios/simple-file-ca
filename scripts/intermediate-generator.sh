...
[[ ${verbose} == 1 ]] && msg msg "Verifying the intermediate certificate authority\n"
[[ ${verbose} == 1 ]] && msg $openssl x509 -noout -text -in "${ia_certs}/ia.cert.pem"
[[ ${verbose} == 1 ]] && msg $openssl verify -CAfile "${ra_cert}" "${ia_certs}/ia.cert.pem"
